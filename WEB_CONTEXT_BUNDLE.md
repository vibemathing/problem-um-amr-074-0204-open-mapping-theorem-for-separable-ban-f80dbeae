...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-074-0204"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-v1",
      "problem_contract_sha256": "492180da966a0dcd37aa612a0b9fcb99e693c77e6a13e58fdf768eefdb15e89b",
      "problem_id": "problem:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae",
      "route_id": "route:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-source-fidelity-01",
      "graph_id": "graph:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is the open mapping theorem for separable Banach spaces provable in $\\mathsf{RCA}_0$, or at least in $\\mathsf{WKL}_0$?"
          },
          "statement_sha256": "d9769b2d876e3deae279e851fda520439c97cb659a8df17763e90f3c84fbee7b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-root",
      "route_id": "route:um-amr-074-0204-open-mapping-theorem-for-separable-ban-f80dbeae-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Logic problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-074-0204-56c8eeb373d0",
        "url": "https://www.unsolvedmath.com/problems/AMR-074-0204"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
